...
export const config = {
	...
	/** ClickHouse HTTP URL for analytics queries. Default: localhost:8123. */
	clickhouseUrl: pick(process.env.CLICKHOUSE_URL, "http://localhost:8123"),
	clickhouseDb: pick(process.env.CLICKHOUSE_DB, "analytics"),
};
